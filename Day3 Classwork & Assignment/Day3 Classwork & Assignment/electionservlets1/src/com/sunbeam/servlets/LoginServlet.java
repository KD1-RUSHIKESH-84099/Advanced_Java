...
public class LoginServlet extends HttpServlet {
	...
	protected void processRequest(HttpServletRequest req, HttpServletResponse resp)
		...
		try (UserDao userDao = new UserDaoImpl()) {
			...
			// due to throws clause, this method can throw only ServletException or
			// IOException. Other types not allowed.
			// in such case we can wrap exception in another unchecked exception or allowed
			// checked exception and throw it.
